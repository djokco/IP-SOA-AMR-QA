...
declare function local:funcTransformation_2($ReceiveInput_receive_InputVariable.AmrPsCollection as element() (:: schema-element(dbp:AmrPsCollection) ::), 
...
local:funcTransformation_2($ReceiveInput_receive_InputVariable.AmrPsCollection, $Response)
