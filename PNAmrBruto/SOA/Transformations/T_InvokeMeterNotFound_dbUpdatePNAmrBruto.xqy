...
declare function local:funcT_invokemeternotfound_dbupdatepnamrbruto($ReceiveInput_receive_InputVariable.AmrBrutoCollection as element() (:: schema-element(dbp:AmrBrutoCollection) ::), 
...
local:funcT_invokemeternotfound_dbupdatepnamrbruto($ReceiveInput_receive_InputVariable.AmrBrutoCollection, $Response)
