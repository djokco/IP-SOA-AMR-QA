...
declare function local:funcT_updatesuccessdbpnamrbruto($ReceiveInput_receive_InputVariable.AmrBrutoCollection as element() (:: schema-element(dbp:AmrBrutoCollection) ::), 
...
local:funcT_updatesuccessdbpnamrbruto($ReceiveInput_receive_InputVariable.AmrBrutoCollection, $Response)
